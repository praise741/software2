                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center">{{ $product -> costprice }}</td>
                                    <td class="center">{{ $product -> sellingprice - $product -> costprice }}</td>
                        <td class="center">{{ ($product -> sellingprice - $product -> costprice) *  $product -> quantity }}</td>
