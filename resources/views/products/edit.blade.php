...
<div class="row">
 ...
 <div class="col-sm-10"><input type="text" class="form-control" name="name" value="{{ $product->name }}"></div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">quantity</label>
                        ...
                        <div class="col-sm-10"><input type="number" name="quantity" value="{{ $product ->quantity }}" class="form-control"></div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label">costprice</label>

                        <div class="col-sm-10"><input type="number" name="costprice" value="{{ $product ->costprice }}" class="form-control"></div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label" >selingprice</label>

                        <div class="col-sm-10"><input type="number" class="form-control" value="{{ $product ->sellingprice }}" name="sellingprice"></div>
                    </div>
